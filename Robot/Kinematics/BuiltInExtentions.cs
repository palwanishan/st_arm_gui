...
namespace Unity.Ros
{
    internal static class BuiltInExtensions
    {
        ...
        public static RotationMatrix GetRotation(this Matrix4x4 matrix4x4)
        {
        ...
        public static RotationMatrix EulerAnglesToRotationMatrix(this Transform transform)
        {
            ...
            Matrix R1 = new Matrix(new double[,]
           {
            ...
            //            RotationMatrix m = new RotationMatrix((R3 * R2 * R1).matrix);
        ...
        public static Unity.Ros.Vector GetPosition(this Matrix4x4 matrix4x4)
        {
            return new Unity.Ros.Vector(matrix4x4[0, 3], matrix4x4[1, 3], matrix4x4[2, 3]);
        }

        public static Matrix4x4 Dot(this Matrix4x4 a, Matrix4x4 b)
        {
            Matrix4x4 result = new Matrix4x4();
